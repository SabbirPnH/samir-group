                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        <div>
                            ...
                            <div className="flex pt-2">
                                <a className="mr-2 border border-white p-2 rounded-full hover:text-[#404A3D] hover:bg-white" href=""><FaTwitter /></a>
                                <a className="mr-2 border border-white p-2 rounded-full hover:text-[#404A3D] hover:bg-white" href=""><FaFacebookF /></a>
                                <a className="mr-2 border border-white p-2 rounded-full hover:text-[#404A3D] hover:bg-white" href=""><FaYoutube /></a>
                                <a className='border border-white p-2 rounded-full hover:text-[#404A3D] hover:bg-white' href=""><FaLinkedinIn /></a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <li className="transition-all duration-300 flex items-center left-0 relative group mb-2">
                                ...
                                <a href="javascript:void(0)" className="text-white w-full transition-all duration-300 group-hover:tracking-widest">Diagnostic Test</a>
                            </li>
                            <li className="transition-all duration-300 flex items-center left-0 relative group mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" className="inline mr-2 h-5 w-5">
                                    <path d="M9 18l6-6-6-6" />
                                </svg>
                                <a href="javascript:void(0)" className="text-white w-full transition-all duration-300 group-hover:tracking-widest">Engine Servicing</a>
                            </li>
                            <li className="transition-all duration-300 flex items-center left-0 relative group mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" className="inline mr-2 h-5 w-5">
                                    <path d="M9 18l6-6-6-6" />
                                </svg>
                                <a href="javascript:void(0)" className="text-white w-full transition-all duration-300 group-hover:tracking-widest">Tires Replacement</a>
                            </li>
                            <li className="transition-all duration-300 flex items-center left-0 relative group mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" className="inline mr-2 h-5 w-5">
                                    <path d="M9 18l6-6-6-6" />
                                </svg>
                                <a href="javascript:void(0)" className="text-white w-full transition-all duration-300 group-hover:tracking-widest">Oil Changing</a>
                            </li>
                            <li className="transition-all duration-300 flex items-center left-0 relative group">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" className="inline mr-2 h-5 w-5">
                                    <path d="M9 18l6-6-6-6" />
                                </svg>
                                <a href="javascript:void(0)" className="text-white w-full transition-all duration-300 group-hover:tracking-widest">Vacuum Cleaning</a>
                            </li>
                        ...
                        <div>
                            ...
                            <div className="relative mx-auto " style={{ maxWidth: '400px' }}>
                                ...
                                <button type="button" className="absolute top-0 rounded-md right-0 mr-2 bg-[#404A3D] text-white mt-2  py-2 px-4 uppercase">SignUp</button>
                            </div>
                        </div>
                    </div>
                </div>
