...
const Footer = () => {
    return (
        <div className="relative px-4 sm:px-20 text-white pt-5 mt-5" style={{
            backgroundImage: "url('/img/StockCake-Textile Factory Scene_1728011217.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
        }}>
            <div className="absolute inset-0 bg-black opacity-90"></div>
            <div className='relative'>
              ...
              <li className="flex gap-5">
                ...
                <div className="post-content">
                  <h6 className="post-title text-md "> <a href="#">Samir Textile Pvt. Ltd.</a> </h6>
                  <div className="meta text-sm pt-2 text-slate-500"><span className="date">Nov 15, 2018</span></div>
                        ...
                        <div>
                            ...
                            <div className="relative mx-auto " style={{ maxWidth: '400px' }}>
                                ...
                                <button type="button" className="absolute top-0  right-0 mr-2 bg-[#F56800] text-white mt-2  py-2 px-4 uppercase">SignUp</button>
                            </div>
                        </div>
                    </div>
                </div>
