      ...
      >
        <div className="flex justify-between items-center py-5 px-4 sm:px-20">
          ...
          <nav className="hidden md:ml-auto md:flex flex-wrap items-center justify-center text-base tracking-wide">
            ...
            <a href={"#company"} onClick={() => setActiveLink("#company")}>
              <li className={`mr-8 list-none ${activeLink === "#company" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Our Company
              </li>
            </a>
            <a href={"#message"} onClick={() => setActiveLink("#message")}>
              <li className={`mr-8 list-none ${activeLink === "#message" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Message
              </li>
            </a>
            <a href={"#mission"} onClick={() => setActiveLink("#mission")}>
              <li className={`mr-8 list-none ${activeLink === "#mission" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Mission & Vision
              </li>
            </a>
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute left-0 border-t w-full bg-white transition-transform duration-300 ease-in-out ${
            isOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          <div className="flex flex-col py-4 px-3 md:hidden text-base uppercase font-semibold">
            <a href={"#home"} onClick={() => setActiveLink("#home")}>
              <li className={`block px-3 py-2 list-none ${activeLink === "#home" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Home
              </li>
            </a>
            <a href={"#about"} onClick={() => setActiveLink("#about")}>
              <li className={`block px-3 py-2 list-none ${activeLink === "#about" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                About
              </li>
            </a>
            <a href={"#company"} onClick={() => setActiveLink("#company")}>
              <li className={`block px-3 py-2 list-none ${activeLink === "#company" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Our Company
              </li>
            </a>
            <a href={"#message"} onClick={() => setActiveLink("#message")}>
              <li className={`block px-3 py-2 list-none ${activeLink === "#message" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Message
              </li>
            </a>
            <a href={"#mission"} onClick={() => setActiveLink("#mission")}>
              <li className={`block px-3 py-2 list-none ${activeLink === "#mission" ? "text-[#E72929]" : "text-[#272B36]"}`}>
                Mission & Vision
              </li>
            </a>
            <a href={"#contact"} onClick={() => setActiveLink("#contact")}>
